...
@step(u'I request the list of tiers of the environment "([^"]*)"')
def i_request_the_list_of_tiers_of_a_environment(step, env_name):
    world.env_requests.get_tiers_environment(env_name)
