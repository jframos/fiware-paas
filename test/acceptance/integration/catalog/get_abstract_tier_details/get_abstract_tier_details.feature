# -*- coding: utf-8 -*-
Feature: Get the details of a tier of an abstract environment

    As a fi-ware user
    I want to be able to the details of a tier of an abstract environment
    ...
    Scenario: Get the details of a tier
        ...
        And a tier has already been added to the abstract environment "nameqa" with data:
            | name       |
            | tiernameqa |
        When I request the details of the tier "tiernameqa" of the abstract environment "nameqa"
    ...
    Scenario Outline: Get the details of a tier with different valid data
        ...
        And a tier has already been added to the abstract environment "<name>" with data:
            | name       |
            | <tiername> |
        When I request the details of the tier "<tiername>" of the abstract environment "<name>"
        Then I receive an "OK" response with data:
            | name       |
            | <tiername> |
