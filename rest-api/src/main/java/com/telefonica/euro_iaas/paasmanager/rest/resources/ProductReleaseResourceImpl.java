...
public class ProductReleaseResourceImpl implements ProductReleaseResource {
	...
	public void delete(String org, String vdc, String envName, String tierName,
			String productReleaseName) throws EntityNotFoundException {
		...
		try {
			...
			ProductRelease productRelease = productReleaseManager
					.load(productReleaseName);
	...
	public void insert(String org, String vdc, String environmentName,
			String tierName, ProductReleaseDto productReleaseDto) {
		...
		try {
			productRelease = productReleaseManager.load(productReleaseDto
					.getProductName()
		...
		try {
			...
			tierManager.addSecurityGroupToProductRelease(claudiaData, tier,
					productRelease);
			tierManager.update(tier);
	...
	public ProductReleaseDto load(String org, String vdc, String environment,
			String tier, String name) throws EntityNotFoundException {
		try {
	...
	public List<ProductReleaseDto> findAll(Integer page, Integer pageSize,
			String orderBy, String orderType, String environment, String tier) {
