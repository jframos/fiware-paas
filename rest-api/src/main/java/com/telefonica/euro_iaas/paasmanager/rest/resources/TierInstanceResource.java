...
public interface TierInstanceResource {
	...
	// @Produces( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	@Consumes( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public Task update(@PathParam("org") String org,
			@PathParam("vdc") String vdc,
			@PathParam("environmentInstance") String environment,
			TierInstanceDto tierInstanceDto,
			@HeaderParam("callback") String callback);
	...
	@Path("/")
	@Produces( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	List<TierInstanceDto> findAll(@QueryParam("page") Integer page,
	...
	@Path("/{name}")
	@Produces( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	TierInstanceDto load(@PathParam("vdc") String vdc,
			@PathParam("environmentInstance") String environmentInstance,
	...
	@Path("/{tierInstance}")
	@Produces( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	Task removeTierInstance(@PathParam("org") String org,
			@PathParam("vdc") String vdc,
			@PathParam("environmentInstance") String environmentInstance,
			@PathParam("tierInstance") String tierInstances,
			@HeaderParam("callback") String callback)
			throws EntityNotFoundException,
