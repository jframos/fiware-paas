 ...
 * 
 */
public class TierInstanceResourceValidatorImpl implements
		TierInstanceResourceValidator {

	public void validateScaleUpTierInstance(String org, String vdc,
			EnvironmentInstance environmentInstance, String tierInst)
		...
		if (!environmentInstance.getVdc().equals(vdc)) {
			throw new InvalidEnvironmentRequestException(
					"EnvironmentInstance does" + "not exists in that vdc");
		}
		...
		if (existTier) {
			throw new InvalidTierInstanceRequestException("TierInstance does"
