...
public interface EnvironmentInstanceOvfResource {
	...
	Task create(@PathParam("org") String org, @PathParam("vdc") String vdc,
			String payload, @HeaderParam("callback") String callback)
	...
	List<EnvironmentInstanceOvfDto> findAll(@QueryParam("page") Integer page,
	 ...
	 * 
	 * @Produces( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	 * String load(@PathParam("vdc") String vdc,
	 * 
