...
@Component
@Scope("request")
public class ApplicationReleaseResourceImpl implements
		ApplicationReleaseResource {
	...
	private static Logger LOGGER = Logger
			.getLogger("ApplicationReleaseResourceImpl");

	/*
	 * (non-Javadoc)
	 * 
	 * @seecom.telefonica.euro_iaas.paasmanager.rest.resources.
	 * ApplicationReleaseResource#findAll(java.lang.Integer, java.lang.Integer,
	 * java.lang.String, java.lang.String)
	 */
	public List<ApplicationRelease> findAll(String artifactName, Integer page,
		...
		if (!StringUtils.isEmpty(artifactName)) {
			try {
				...
				throw new PaasManagerServerRuntimeException(
						"Can not find the artifact " + artifactName, e);
			}
		}
	 ...
	 * 
	 * @seecom.telefonica.euro_iaas.paasmanager.rest.resources.
	 * ApplicationReleaseResource#load(java.lang.String)
	 */
