...
public interface AbstractEnvironmentResource {
    ...
    void insert(@PathParam("org") String org, EnvironmentDto environmentDto);
    ...
    @Path("/{envName}")
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    EnvironmentDto load(@PathParam("org") String org, @PathParam("envName") String name)
    ...
    @Path("/{envName}")
    @Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    void delete(@PathParam("org") String org, @PathParam("envName") String envName)
