...
public class RuleManagerImpl implements RuleManager {
	...
	public Rule create(ClaudiaData claudiaData, Rule rule)
			throws InvalidEntityException, AlreadyExistsEntityException,
			InfrastructureException {
		log.debug("Create rule " + rule.getFromPort() + " from security group "
				+ rule.getIdParent());
	...
	public void destroy(ClaudiaData claudiaData, Rule rule)
			throws InvalidEntityException, InfrastructureException {
		log.debug("Destroying rule " + rule.getFromPort()
				+ " from security group " + rule.getIdParent());
