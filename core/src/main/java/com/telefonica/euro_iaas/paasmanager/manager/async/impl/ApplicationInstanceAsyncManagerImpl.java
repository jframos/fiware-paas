...
public class ApplicationInstanceAsyncManagerImpl implements
	...
	* deployed 
	* @param applicationRelease to be deployed
	...
	*/   
     ...
     */
    private void updateErrorTask(String resourceName, String baseUrl, Task task,
            String message, Throwable t) {
        String piResource = MessageFormat.format(
                propertiesProvider.getProperty(baseUrl),
    ...
    private void updateErrorTask(Task task, String message, Throwable t) {
        ...
        LOGGER.info("An error occurs while installing an application release on a" +
