 ...
 */
public class InvalidSecurityGroupRequestException extends Exception {

    public InvalidSecurityGroupRequestException(String msg) {
        super(msg);
    }

    public InvalidSecurityGroupRequestException(Throwable e) {
        super(e);
    }

    public InvalidSecurityGroupRequestException(String msg, Throwable e) {
        super(msg, e);
    }
}
