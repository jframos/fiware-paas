...
public interface OpenStackUtil {
     ...
     * Amount of root Disk.
     */
    String OPENSTACK_COMPUTE_STORAGE_ROOT =
        "org.openstack.compute.storage.root";
    /**
     * name of OpenStack constant name: org.openstack.compute.storage.root.
     * Amount of root Disk.
     */
    String OPENSTACK_COMPUTE_STORAGE_EPHEMERAL =
        "org.openstack.compute.storage.ephemeral";
    /**
     * name of OpenStack constant name: org.openstack.compute.swap.
     * Amount of swap.
     */
    ...
    String ERROR_AUTHENTICATION_HEADERS = "Authentication Token,"
        + " Tenant ID and User must be initialized...";

    /**
     * It adds an network interface to the public router.
     */
    String addInterfaceToPublicRouter(PaasManagerUser user,
                                      NetworkInstance net, String region)
            throws OpenStackException;

    /**
     * It adds an interface to the router.
     */
    String addInterface(String idRouter, NetworkInstance net,
                        String region, String token, String vdc)
            throws OpenStackException;

    /**
     * Method to add an interface to the router.
     */
    String addRouterInterface(String routerId, String subNetId,
                              String region, String token, String vdc)
            throws OpenStackException;
     ...
     * @throws OpenStackException
     */
    String createNetwork(String payload, String region,
                         String token, String vdc)
        throws OpenStackException;

    /**
     * Method to create a new router.
     */
    String createRouter(RouterInstance router, String region,
                        String token, String vdc) throws OpenStackException;

    /**
     * Deploys a VM inOpenStack.
     */
    String createServer(String payload, String region,
                        String token, String vdc) throws OpenStackException;

    /**
     * Method to create a new subnet.
     */
    String createSubNet(SubNetworkInstance subNet, String region,
                        String token, String vdc) throws OpenStackException;

    /**
     * Method to delete a network.
     */
    String deleteNetwork(String networkId, String region,
                         String token, String vdc) throws OpenStackException;

    /**
     * Undeploys a router in Openstack.
     */
    String deleteRouter(String routerId, String region,
                        String token, String vdc)
        throws OpenStackException;
     ...
     */
    String deleteServer(String serverId, String region,
                        String token, String vdc)
        throws OpenStackException;
     ...
     */
    void deleteSubNetwork(String idSubNet, String region,
                          String vdc, String token)
        throws OpenStackException;

    /**
     * Obtain the floating IP's of a certain tenantID.
     */
    String getFloatingIP(PaasManagerUser user, String region)
        throws OpenStackException;

    /**
     * Method to get a single Network.
     */
    String getNetworkDetails(String networkId, String region,
                             String token, String vdc)
        throws OpenStackException;
     ...
     */
    String getNetworks(String region, String token, String vdc)
        throws OpenStackException;
    ...
    String getServer(String serverId, String region, String token, String vdc)
        throws OpenStackException;

    /**
     * List all servers in OpenStack.
     */
    String listServers(String region, String token, String vdc)
        throws OpenStackException;

    /**
     * List all ports in OpenStack.
     */
    String listPorts(PaasManagerUser user, String region)
        throws OpenStackException;

    /**
     * It removes the interface of the network in the router.
     */
    String removeInterface(RouterInstance router, String net,
                           String region, String token, String vdc)
       throws OpenStackException;
     ...
     */
    String getAbsoluteLimits(PaasManagerUser user, String region)
        throws OpenStackException;

    /**
     * It gets the subnetwork details.
     */
    String getSubNetworkDetails(String subNetworkId, String region,
                                String token, String vdc)
        throws OpenStackException;
    ...
    String listNetworks(PaasManagerUser user, String region)
        throws OpenStackException;

    /**
     * It gets the subnetwork from the user.
     */

    String listSubNetworks(PaasManagerUser user, String region)
        throws OpenStackException;
	...
	String joinNetworks(NetworkInstance networkInstance,
			NetworkInstance networkInstance2, String token)
        throws OpenStackException;

	void disAllocateFloatingIP(String region, String token, String vdc,
                               String floatingIp) throws OpenStackException;
