...
public interface ProductInstallator {
	 ...
	 * @throws ProductInstallatorException
	 */
	void installArtifact(ProductInstance productInstance, Artifact artifact)
			throws ProductInstallatorException;
	 ...
	 * @throws ProductInstallatorException
	 */
	void uninstallArtifact(ProductInstance productInstance, Artifact artifact)
			throws ProductInstallatorException;
	 ...
	 * SDC, for instance)
	 */
	void deleteNode(String vdc, String nodeName)
			throws ProductInstallatorException;
	 ...
	 * SDC, for instance)
	 */
	ChefClient loadNode(String vdc, String nodeName)
			throws ProductInstallatorException, EntityNotFoundException;
}
