 ...
 *
 */
public class RECVMServiceImpl extends AbstractBaseService 
	implements RECVMService {
	...
	public void configureVM(String recVapp, String recVMname, String appId)
		...
		Reference urlGet = new Reference(getBaseHost()+ MessageFormat.format(
                ClientConstants.BASE_VM_PATH, appId) + "/" + recVMname);
	...
	/*private Document getDocumentFromVapp(String vapp, String ip, 
			String login, String password) 
		throws ProductInstallatorException {
	        
		VirtualSystemType vs = new VirtualSystemType();
		//vappUtils.getVEEName();
		...
		try {
			...
			String msg = "Esta seccion ya existe. Desc: " + e.getMessage();
			throw new ProductInstallatorException(msg);
		} catch (InvalidSectionException e) {
			String msg = "Esta seccion NO es válida. Desc: " + e.getMessage();
			throw new ProductInstallatorException(msg);
		}
		...
		//ovfSerializer.writeXML(vs, os);
		ovfSerializer.writeXML(virtualSystem, os)
