...
public interface ClaudiaClient {
	 ...
	 */
	String browseVDC(ClaudiaData claudiaData)
			throws ClaudiaResourceNotFoundException;
	 ...
	 */
	String browseService(ClaudiaData claudiaData)
			throws ClaudiaResourceNotFoundException;
	...
	/**
	 * Deploy a service known as ServiceId for a given Org, Customer
	 * (deployService).
	 * 
	 * @param org
	 *            Organization identifier
	 ...
	 * @throws InfrastructureException
	 */
	void undeployVMReplica(ClaudiaData claudiaData, TierInstance tierInstance)
			throws InfrastructureException;
	 ...
	 */
	String deployVDC(ClaudiaData claudiaData, String cpu, String mem,
	...
	/*
	 * String deployServiceFull(ClaudiaData claudiaData, String ovfs) throws
	 ...
	 * @throws InfrastructureException
	 */
	void deployVM(ClaudiaData claudiaData, Tier tier, int replica, VM vm)
			throws InfrastructureException;
	 ...
	 * @throws InfrastructureException
	 */
	void undeployVM(ClaudiaData claudiaData, TierInstance tierInstance)
			throws InfrastructureException;
	 ...
	 * @throws InfrastructureException
	 */
	void undeployService(ClaudiaData claudiaData)
			throws InfrastructureException;
	...
	String obtainOS(String org, String vdc, String service, String vmName,
			PaasManagerUser user) throws OSNotRetrievedException,
			ClaudiaResourceNotFoundException;
	 ...
	 * @throws OSNotRetrievedException
	 */
	String getVApp(String org, String vdc, String service, String vmName,
			PaasManagerUser user) throws IPNotRetrievedException,
	...
	String createImage(ClaudiaData claudiaData, TierInstance tierInstance)
	 ...
	 * @throws InfrastructureException
	 */
	List<String> getIP(ClaudiaData claudiaData, String tierName, int replica,
			VM vm) throws InfrastructureException;
	 ...
	 * @throws InfrastructureException
	 */
	String deployServiceFull(ClaudiaData claudiaData, String ovf)
			throws InfrastructureException;
	 ...
	 * @throws ClaudiaResourceNotFoundException
	 */
	String browseVMReplica(ClaudiaData claudiaData, String tierName,
