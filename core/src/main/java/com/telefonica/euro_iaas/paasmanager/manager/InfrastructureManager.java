...
public interface InfrastructureManager {
	 ...
	 * @throws InfrastructureException
	 */
	void deleteEnvironment(ClaudiaData claudiaData,
			EnvironmentInstance envInstance) throws InfrastructureException;

	/**
	 * Clone the template to a VM with products installed (Element of
	 * TierInstance)
	 * 
	 * @param templateName
	 ...
	 * @throws InfrastructureException
	 */
	TierInstance cloneTemplate(String templateName)
			throws InfrastructureException;
	 ...
	 */
	/*
	 * String ImageScalability(String org, String vdc, String vapp, String
	 * service, String vmName, String fqn, PaasManagerUser user) throws
	 * InfrastructureException;
	 */
	String ImageScalability(ClaudiaData claudiaData, TierInstance tierInstance)
			throws InfrastructureException;
	 ...
	 * @throws InfrastructureException
	 */
	Template createTemplate(TierInstance tierInstance)
			throws InfrastructureException;
	 ...
	 * @throws InfrastructureException
	 */
	void deployVM(ClaudiaData claudiaData, Tier tier, int replica, String vmOVF, VM vm)
			throws InfrastructureException;
