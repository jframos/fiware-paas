 ...
 * 
 */
public class VirtualServiceAsyncManagerImpl implements
		VirtualServiceAsyncManager {
	 ...
	 * 
	 * @see
	 * com.telefonica.euro_iaas.paasmanager.manager.async.VirtualServiceAsyncManager
	 * #create(java.lang.String,
	 * com.telefonica.euro_iaas.paasmanager.model.Task, java.lang.String)
	 */
	@Async
	public void create(String virtualServiceName, String virtualService,
		...
		try {
			...
			log.info("The VirtualService " + virtualServiceName
			...
			String errorMsg = "Unexpected error installing virtualService : "
					+ virtualServiceName + ". Description:" + e.getMessage();
			updateErrorTaskOnInstall(virtualServiceName, task, errorMsg, e);
		} finally {
	 ...
	 */
	private void updateSuccessTask(Task task, String virtualServiceName)
			throws TaskNotFoundException {
		InstallableInstance productInstance;
		Task loadedTask;
		String piResource = MessageFormat.format(propertiesProvider
				.getProperty(VIRTUAL_SERVICE_BASE_URL), virtualServiceName); // the
		// virtualServiceName
	 ...
	 */
	private void updateErrorTaskOnInstall(String virtualServiceName, Task task,
	 ...
	 */
	private void updateErrorTask(String virtualServiceName, Task task,
			String message, Throwable t) {

		String aiResource = MessageFormat.format(propertiesProvider
				.getProperty(VIRTUAL_SERVICE_BASE_URL), virtualServiceName);
	...
	private void updateErrorTask(Task task, String message, Throwable t) {
		...
		log.info("An error occurs while installing Virtual Service. See task "
	 ...
	 */
	public void setVirtualServiceManager(
