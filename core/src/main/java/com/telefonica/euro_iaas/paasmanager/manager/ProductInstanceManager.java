...
import com.telefonica.euro_iaas.commons.dao.InvalidEntityException; /*import com.telefonica.euro_iaas.paasmanager.exception.AlreadyInstalledException;
import com.telefonica.euro_iaas.paasmanager.exception.ApplicationIncompatibleException;
import com.telefonica.euro_iaas.paasmanager.exception.ApplicationInstalledException;
...
import com.telefonica.euro_iaas.paasmanager.exception.ProductReconfigurationException; //import com.telefonica.euro_iaas.paasmanager.exception.NotTransitableException;
...
public interface ProductInstanceManager {
	 ...
	 * @throws InvalidEntityException
	 */
	ProductInstance install(TierInstance tierInstance, ClaudiaData claudiaData, String envName,
			ProductRelease product, List<Attribute> attributes)
			throws ProductInstallatorException,
	...
	ProductInstance create(ProductInstance productInstance)
