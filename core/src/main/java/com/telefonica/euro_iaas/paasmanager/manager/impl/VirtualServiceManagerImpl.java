...
public class VirtualServiceManagerImpl implements VirtualServiceManager {
	...
	/* (non-Javadoc)
	 * @see com.telefonica.euro_iaas.paasmanager.manager.VirtualServiceManager#create(java.lang.String, java.lang.String)
	 */
	public void create(String virtualServiceName, String payload)
		...
		recVirtualServiceService = 
				client.getRECVirtualServiceService(baseUrl, mediaType);
		for (int i= 0; i< acProductSections.size(); i++) {
			...
			recVirtualServiceService.createVirtualService(appId, vmId, picId, acId, 
