...
public interface EnvironmentManager {
	 ...
	 */
	Environment create(ClaudiaData claudiaData, Environment environment)
	 ...
	 */
	Environment updateTier(Environment environment, Tier tierold, Tier tiernew)
	 ...
	 */
	void destroy(ClaudiaData data, Environment environment)
	 ...
	 * @throws InvalidEntityException
	 */
	Environment update(Environment name) throws EntityNotFoundException,
