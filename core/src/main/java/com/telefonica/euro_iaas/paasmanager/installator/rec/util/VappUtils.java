...
public interface VappUtils {
	 ...
	 * @throws ProductInstallatorException
	 */
	String getRECVapp(String ovf, String ip, String login, String password)
			throws ProductInstallatorException;
	 ...
	 * @throws ProductInstallatorException
	 */
	List<String> getPICProductSections(String ovf)
			throws ProductInstallatorException;
	 ...
	 * @throws ProductInstallatorException
	 */
	List<String> getACProductSections(String ovf)
			throws ProductInstallatorException;
	 ...
	 * @throws ProductInstallatorException
	 */
	List<String> getACProductSectionsByPicId(String ovf, String picId)
			throws ProductInstallatorException;
	 ...
	 * @throws ProductInstallatorException
	 */
	String getPICProductSection(String picId, String ovf)
			throws ProductInstallatorException;
