...
public class EnvironmentInstanceAsyncManagerImplTest {
    ...
    public void setUp() throws Exception {
        ...
        productRelease.setDescription("desc");
        productRelease.setProductType(new ProductType("name","desc"));
        ...
        expectedEnvironment.setTiers(tiers);
        ...
        TierInstance expectedTierInstance = new TierInstance (tier, productInstances);
        ...
        when(productInstanceManager.install(any(VM.class), any(String.class),
        		any(ProductRelease.class), (List<Attribute>) any(Object.class))).thenReturn(expectProductInstance);
        
          
        environmentManager = mock(EnvironmentManager.class);
        when(environmentManager.load(any(String.class))).thenReturn(expectedEnvironment);
    ...
    @Test
    public void CreateWhenEverithingIsOk() throws Exception {
