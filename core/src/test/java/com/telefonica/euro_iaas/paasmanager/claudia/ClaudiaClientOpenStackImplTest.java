...
public class ClaudiaClientOpenStackImplTest {
	...
	public void setUp() throws Exception {
		...
		when(
				openStackUtil.createServer(any(String.class),
						any(PaasManagerUser.class))).thenReturn("response");
                when(openStackUtil.createNetwork(any(String.class),
                        any(PaasManagerUser.class))).thenReturn(expectedNetwork);
                when(openStackUtil.createSubNet(any(String.class), any(String.class),
