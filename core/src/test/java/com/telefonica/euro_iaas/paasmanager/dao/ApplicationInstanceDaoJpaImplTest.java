...
//		implements ApplicationInstanceDao {
    ...
    */
	/*public void testCreate() throws Exception {
	    ...
	    applicationReleaseDaoJpaImplTest.setApplicationTypeDao(applicationTypeDao);
	    applicationReleaseDaoJpaImplTest.setApplicationReleaseDao(applicationReleaseDao);
	    applicationReleaseDaoJpaImplTest.testCreate();
    
	    ApplicationRelease applicationRelease = applicationReleaseDao.findAll().get(0);
    
	    
	    EnvironmentInstanceDaoJpaImplTest environmentInstanceDaoJpaImplTest 
			= new EnvironmentInstanceDaoJpaImplTest();
	    environmentInstanceDaoJpaImplTest.setOsDao(osDao);
	    environmentInstanceDaoJpaImplTest.setServiceDao(serviceDao);
	    environmentInstanceDaoJpaImplTest.setProductReleaseDao(productReleaseDao);
	    environmentInstanceDaoJpaImplTest.setProductInstanceDao(productInstanceDao);
	    ...
	    environmentInstanceDaoJpaImplTest.setEnvironmentTypeDao(environmentTypeDao);
	    environmentInstanceDaoJpaImplTest.setEnvironmentInstanceDao(environmentInstanceDao);
    ...
    */
    ...
    applicationReleaseDaoJpaImplTest.setApplicationTypeDao(applicationTypeDao);
    applicationReleaseDaoJpaImplTest.setApplicationReleaseDao(applicationReleaseDao);
    applicationReleaseDaoJpaImplTest.testCreate2();
   ...
   /* public void testFindAllAndUpdate() throws Exception {
    ...
    public void testFindByCriteria() throws Exception {
        ...
        ApplicationInstance createdApplicationInstance1 = applicationInstances.get(0);
        ApplicationInstance createdApplicationInstance2 = applicationInstances.get(1);
