...
public class ArtifactDaoJpaImplTest extends AbstractJpaDaoTest {
    ...
    public final static String ARTIFACT_NAME = "ArtfactName";
    public final static String ARTIFACT_PATH = "/Artifact/path";
    public final static String ARTIFACT_TYPE = "ArtfactType";
    ...
    public void testCreate() throws Exception {
    	...
    	ProductType productType 
    		= productTypeDaoJpaImplTest.create(new ProductType("ProductType", "ProductTypeDesc"));
    	
    	ArtifactTypeDaoJpaImplTest artifactTypeDaoJpaImplTest 
			= new ArtifactTypeDaoJpaImplTest();
    	artifactTypeDaoJpaImplTest.setArtifactTypeDao(artifactTypeDao);
	
    	ArtifactType artifactType = artifactTypeDao.create(new ArtifactType(ARTIFACT_NAME, ARTIFACT_PATH
        		, productType));
    	...
    	Artifact createdArtifact = artifactDao.create(artifact); 	
