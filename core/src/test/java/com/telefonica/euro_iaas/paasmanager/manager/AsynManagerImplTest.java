...
public class AsynManagerImplTest {
    ...
    @Test
    public void testCreateTierInstanceManager () throws AlreadyExistsEntityException, InvalidEntityException, InfrastructureException, EntityNotFoundException, NotUniqueResultException, InvalidProductInstanceRequestException, ProductInstallatorException {
    	ClaudiaData claudiaData = new ClaudiaData("org", "vdc", "service");
        String callback ="";
        Task task = new Task ();

        Mockito.doNothing().when (tierInstanceManager).create(any(ClaudiaData.class), any(TierInstance.class), any(EnvironmentInstance.class), 
    ...
    @Test
    public void testUpdateTierInstanceManager () throws AlreadyExistsEntityException, InvalidEntityException, InfrastructureException, EntityNotFoundException, NotUniqueResultException, InvalidProductInstanceRequestException, ProductInstallatorException, ProductReconfigurationException {
    	ClaudiaData claudiaData = new ClaudiaData("org", "vdc", "service");
        String callback ="";
        Task task = new Task ();

        Mockito.doNothing().when (tierInstanceManager).update(any(ClaudiaData.class), any(TierInstance.class), any(EnvironmentInstance.class));
        tierInstanceAsyncManagerImpl.update(claudiaData, tierInstanceShard, environmentInstance, task, callback);

    }
    
    @Test
    public void testCreateTierInstanceManagerError () throws AlreadyExistsEntityException, InvalidEntityException, InfrastructureException, EntityNotFoundException, NotUniqueResultException, InvalidProductInstanceRequestException, ProductInstallatorException {
    	ClaudiaData claudiaData = new ClaudiaData("org", "vdc", "service");
        String callback ="";
        Task task = new Task ();

        Mockito.doThrow(new InfrastructureException( "test")).when (tierInstanceManager).create(any(ClaudiaData.class), any(TierInstance.class), any(EnvironmentInstance.class), 
        		any(SystemPropertiesProvider.class));
        tierInstanceAsyncManagerImpl.create(claudiaData, tierInstanceShard, environmentInstance, task, callback);
    ...
    @Test
    public void testDeleteTierInstanceManager () throws AlreadyExistsEntityException, InvalidEntityException, InfrastructureException, EntityNotFoundException {
    	ClaudiaData claudiaData = new ClaudiaData("org", "vdc", "service");
        String callback ="";
        Task task = new Task ();

        Mockito.doNothing().when (tierInstanceManager).delete(any(ClaudiaData.class),  any(TierInstance.class), any(EnvironmentInstance.class));
        tierInstanceAsyncManagerImpl.delete(claudiaData, tierInstanceShard, environmentInstance, task, callback);

    }
    
    @Test
    public void testCreateProductInstanceManager () throws AlreadyExistsEntityException, InvalidEntityException, InfrastructureException, EntityNotFoundException, NotUniqueResultException, InvalidProductInstanceRequestException, ProductInstallatorException {
    	ClaudiaData claudiaData = new ClaudiaData("org", "vdc", "service");
        String callback ="";
        Task task = new Task ();

        when (productInstanceManager.install(any(TierInstance.class),
        		any(ClaudiaData.class), any(String.class), any(ProductRelease.class), any(HashSet.class))).thenReturn(productInstance);
        productInstanceAsyncManagerImpl.install(tierInstanceShard, claudiaData, "env", productReleaseShard, null, task, callback);

    }
    
    
    @Test
    public void testCreateProductInstanceManagerError () throws AlreadyExistsEntityException, InvalidEntityException, InfrastructureException, EntityNotFoundException, NotUniqueResultException, InvalidProductInstanceRequestException, ProductInstallatorException {
    	ClaudiaData claudiaData = new ClaudiaData("org", "vdc", "service");
        String callback ="";
        Task task = new Task ();
    ...
    @Test
    public void testCreateProductInstanceManagerErrorII () throws AlreadyExistsEntityException, InvalidEntityException, InfrastructureException, EntityNotFoundException, NotUniqueResultException, InvalidProductInstanceRequestException, ProductInstallatorException {
    	ClaudiaData claudiaData = new ClaudiaData("org", "vdc", "service");
        String callback ="";
        Task task = new Task ();
        ...
        when (productInstanceManager.install(any(TierInstance.class),
        		any(ClaudiaData.class), any(String.class), any(ProductRelease.class), any(HashSet.class))).
        		thenThrow(new InvalidProductInstanceRequestException( "test"));
        when ( productInstanceManager.loadByCriteria(any(ProductInstanceSearchCriteria.class))).thenThrow(new EntityNotFoundException(ProductInstance.class, callback, task));
        productInstanceAsyncManagerImpl.install(tierInstanceShard, claudiaData, "env", productReleaseShard, null, task, callback);
    ...
    @Test
    public void testDeleteProductInstanceManager () throws AlreadyExistsEntityException, InvalidEntityException, InfrastructureException, EntityNotFoundException, ProductInstallatorException {
    	ClaudiaData claudiaData = new ClaudiaData("org", "vdc", "service");
        String callback ="";
        Task task = new Task ();
