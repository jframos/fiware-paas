...
public class ApplicationReleaseDaoJpaImplTest extends AbstractJpaDaoTest {
    ...
    public final static String APPR_NAME = "APPReleaseName";
    public final static String APPR_DESCRIPTION = "APPReleaseDescription";
    public final static String APPR_VERSION = "APPReleaseVersion";
    ...
    */
    public void testCreate() throws Exception {
    	...
    	EnvironmentType environmentType 
			= environmentTypeDaoJpaImplTest.create(new EnvironmentType("EnvName", "EnvDesc"));
    	
    	List<EnvironmentType> environmentTypes = new ArrayList<EnvironmentType>();
    	environmentTypes.add(environmentType);
    	
    	AppicationTypeDaoJpaImplTest appicationTypeDaoJpaImplTest 
    		= new AppicationTypeDaoJpaImplTest ();
    	appicationTypeDaoJpaImplTest.setApplicationTypeDao(applicationTypeDao);
    	
    	ApplicationType applicationType 
    		= appicationTypeDaoJpaImplTest.create(new ApplicationType(
    				"ApplicationTypeName",
    				"ApplicationTypeDesc",
    				environmentTypes));
        ...
        transitableReleases.add(new ApplicationRelease(APPR2_NAME,APPR2_VERSION));
    ...
    */
    public void testCreate2() throws Exception {
    	...
    	EnvironmentType environmentType 
			= environmentTypeDaoJpaImplTest.create(new EnvironmentType("Env2Name", "Env2Desc"));
    	...
    	ApplicationType applicationType 
    		= appicationTypeDaoJpaImplTest.create(new ApplicationType(
    				"Application2TypeName",
    				"Application2TypeDesc",
    				environmentTypes));
    	
    	List<ApplicationRelease> transitableReleases 
        	= new ArrayList<ApplicationRelease>();
        transitableReleases.add(new ApplicationRelease(APPR_NAME,APPR_VERSION));
    ...
    public void testFindAllAndUpdate() throws Exception {
        ...
        assertEquals(1, applicationReleases.size());
        ApplicationRelease applicationRelease = applicationReleases.get(0);
