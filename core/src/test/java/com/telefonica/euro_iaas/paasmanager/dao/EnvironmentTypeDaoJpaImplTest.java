...
public class EnvironmentTypeDaoJpaImplTest extends AbstractJpaDaoTest {
    ...
    public EnvironmentType create(EnvironmentType environmentType) throws InvalidEntityException,
    ...
    public EnvironmentType load(Long arg0) throws EntityNotFoundException {
        EnvironmentType environmentType = environmentTypeDao.load(environmentTypeDao.findAll().get(0).getName());
        assertNotNull(environmentType.getId());
        return environmentType;
    }
    ...
    public EnvironmentType update(EnvironmentType arg0) throws InvalidEntityException {
