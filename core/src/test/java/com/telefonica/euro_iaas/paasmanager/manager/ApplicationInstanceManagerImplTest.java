	...
	//	when(productInstallator.installArtifact(
	 ...
	 @Test
	    ...
	    /*    ApplicationInstanceManagerImpl manager = new ApplicationInstanceManagerImpl();
	        ...
	        ApplicationReleaseDto applicationRelease = null;
	        // execution
	        ApplicationInstance installedApp = manager.install("dd","ss", environmentInstance, applicationRelease);
	        // make assertions
	        ApplicationRelease applicationReleaseAfter = null;*/
	    //    Assert.assertEquals(installedApp.getApplicationRelease(), applicationReleaseAfter);
