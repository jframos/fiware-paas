...
public class EnvironmentDto {
	 ...
	 * @param name
	 */
	public EnvironmentDto(EnvironmentType environmentType,
			List<TierDto> tierDtos, String name, String description) {
	...
	public EnvironmentDto(List<TierDto> tierDtos, String name,
			String description) {
		this.tierDtos = tierDtos;
		this.name = name;
		this.description = description;
