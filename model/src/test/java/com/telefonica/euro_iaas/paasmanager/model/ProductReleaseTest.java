...
public class ProductReleaseTest extends TestCase {
	...
	public void setUp() throws Exception {
		...
		String productReleaseStringNoAttributes = "{" +
				"\"releaseNotes\":\"Tomcat server 7\"," +
				"\"version\":\"7\"," +
				"\"product\":" +
					"{" +
						"\"name\":\"tomcat\"," +
						"\"description\":\"tomcat J2EE container\"" +
						/*"\"attributes\":" +
							"[" +
		...
		String productReleaseStringOneAttribute = "{" +
				...
				"\"supportedOOSS\":" +
					"[" +
						...
						"}," +
						"{" +
							"\"description\":\"Centos 2.9\"," +
							"\"name\":\"Centos\"," +
							"\"osType\":\"76\",\"version\":\"2.9\"" +
						"}" +
					"]" +
				"}";
		
		String productReleaseNoReleaseNotesNoSSOO = "{" +
				"\"version\":\"1.0\"," +
				"\"product\":" +
					"{" +
						"\"name\":\"henar10\"," +
						"\"attributes\":{\"key\":\"ssl_port5\",\"value\":\"8443\"}" +
					"}" +
				"}";
