...
public class EnvironmentOKStepsdef {
    ...
    public void getProductReleases(DataTable table) {
        ...
        for (List<String> row : table.raw()) {
            ...
            ProductRelease tomcat7 = new ProductRelease(productReleaseDto.getProductName(),
                    productReleaseDto.getVersion(), "Tomcat server 7", null);
            try {
    ...
    public void iCreateEnvironmentNotFoundException(String envName) throws Exception {
